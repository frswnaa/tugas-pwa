    ...
    fetchApi(team_id_url)
      ...
      .then(function (data) {
        ...
        teamHTML += `
                      ...
                      `;
        document.getElementById("body-content").innerHTML = teamHTML;
        // kirim objek data dari parsing json agar bisa disimpan ke indexed db
        resolve(data);
      });
  })
}
            ...
            <div class="col s12">
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <p align="center">Nickname : ${data.shortName}<br>Address :${data.address}
                    <br>Founded :${data.founded}<br>Club Colors :${data.clubColors}<br>Venue :${data.venue}
                </p>
                </div>
              </div>
            </div>
